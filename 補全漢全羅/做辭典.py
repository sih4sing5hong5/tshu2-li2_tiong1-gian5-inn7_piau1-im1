...
例句總整理=os.path.join(這馬所在, '訓練用斷詞例句總.txt')
...
#/home/joseyarashio/文件/srilm-1.7.1/bin/i686-m64/ngram-count -order 3 -interpolate -wbdiscount -text 新建例句.txt -lm 斷詞例句5.lm
