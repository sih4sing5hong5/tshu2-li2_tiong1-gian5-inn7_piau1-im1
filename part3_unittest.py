...
def compare_mid_string(s1):
    ...
    ''' 
    tmp=''
    fstIndx = compare_fst_string(s1)
    endIndx = compare_end_string(s1)
    while(True):
        if s1[fstIndx] == ' ':
            fstIndx=fstIndx+1
        elif (s1[endIndx-1] == '/'):
...
class MyTestCase(unittest.TestCase):
    ...
    def test_compare_fst_string(self):
        ...
        for i in range(0,len(self.default_greeting)):
            ...
            self.assertEqual( self.default_greeting[i][0:compare_fst_string( self.default_greeting[i] )] , test_fst_greeting[i] )
    ...
    def test_compare_end_string(self):
        ...
        for i in range(0,len(self.default_greeting)):
            ...
            self.assertEqual( self.default_greeting[i][compare_end_string(self.default_greeting[i]):len(self.default_greeting[i])], test_end_greeting[i])
    ...
    def test_compare_mid_string(self):
        ...
        for i in range(0,len(self.default_greeting)):
            ...
            self.assertEqual(compare_mid_string(self.default_greeting[i]),test_mid_greeting[i])
