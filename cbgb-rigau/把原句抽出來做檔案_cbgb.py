...
if __name__ == '__main__':
    file1 = open('Trans/Trans05_20121027_Neighbor-20140416-20140731-20140803-new.trs.txt', 'r')#此檔案為正確答案的檔案
    writefile=open('校正後拼音.txt', 'wt')#此檔案為正確答案的檔案
    rate=0
    num_word=0
    num_sentance=0
    num_diff_sentance=0
